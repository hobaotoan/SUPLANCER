<template>
    <div class="view p-4 animate__animated animate__fadeIn">
        <div class="infor container">
            ...
            <div
                class="row m-0 pt-3 pb-5 border-bottom justify-content-between"
            >
...
import InforInternship from "../../components/Leader/ProgressAssess/InforInternship.vue";
...
export default {
    name: "LeaderView",
    components: { InforInternship, InforProject, TitleStructure, InforFreelancer },
    computed: {
