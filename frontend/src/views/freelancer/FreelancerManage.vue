                    ...
                    >
                        <div class="col-3 me-5">
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="bi bi-calendar-week fs-2 me-2"
                                    ></i>
                        ...
                        <div class="col-3 me-5">
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="bi bi-clipboard-check fs-2 me-2"
                                    ></i>
                        ...
                        <div class="col-3">
                            <router-link
                                to="/freelancer/manage/view-assess-leader"
                                class="router-link"
                            >
                                <button
                                    type="button"
...
export default {
    ...
    mounted() {
        ...
        const viewAssessLeader = document.querySelector(
            ".view-assess-leader"
        );
        this.clearDisabled();
        if (viewProgress) {
