<template>
    ...
    >
        ...
        <div class="col-7" style="min-height: 200px">
            ...
            <div class="col-12 my-1">
                <strong>Công nghệ: </strong> {{ freelancer.technology }}
            </div>
            <div class="col-12 my-1">
                <strong>Dự án: </strong> {{ freelancer.projects }}
            </div>
        </div>
        <div class="col-12"><strong>Thư: </strong> {{ freelancer.message }}</div>
...
export default {
    ...
    computed: mapGetters({ freelancer: "getFreelancerDetail"},{ account: "getAccount" }),
};
</script>
