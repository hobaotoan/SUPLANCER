<template>
    <div class="view-assess-leader animate__animated animate__fadeIn my-4">
        <div class="assess-leader__title me-5">
            <h2
                class="header-list label m-0 pt-2 fw-bold"
                style="color: #2C542F"
            >
                Đánh giá công việc của leader
            </h2>
            <div class="line my-3"></div>
        </div>
        <div class="assess-leader__detail mb-4">
            <p class="assess-leader__date" v-if="startDate">
                <strong>Thời gian làm việc:</strong>
                <span> từ ngày {{ startDate }}</span>
            </p>
            <p v-else style="color: red">Bạn chưa tham gia thực tập</p>
            <p class="assess-leader__status" v-if="startDate">
...
export default {
    name: "ViewAssessLeader",
    computed: {
        ...mapGetters({
            points: "getLeaderAssess",
