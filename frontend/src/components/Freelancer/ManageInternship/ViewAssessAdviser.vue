<template>
  <div class="view-assess-adviser animate__animated animate__fadeIn my-4">
    <div class="assess-adviser__title me-5">
      <h2 class="header-list label m-0 pt-2 fw-bold" style="color: #2c542f">
        Đánh giá công việc của adviser
      </h2>
      <div class="line my-3"></div>
    </div>
    <div class="assess-adviser__detail mb-4">
      <p class="assess-adviser__date" v-if="startDate">
        <strong>Thời gian làm việc:</strong>
        <span> từ ngày {{ startDate }}</span>
      </p>
      <p v-else style="color: red">Bạn chưa tham gia thực tập</p>
      <p class="assess-adviser__status" v-if="startDate">
...
export default {
  name: "ViewAssessAdviser",
  computed: {
    ...mapGetters({
      points: "getAdviserAssess",
