...
const taskModule = {
    ...
    actions: {
        async setTaskList({ commit }, freelancerId) {
            try {
                const res = await axios.get(
                    `${config.domain}/project/get-all-tasks`,
                    {
                        params: { freelancerId },
        ...
        async deleteTask({ commit }, taskId) {
            try {
                const res = await axios.delete(
                    `${config.domain}/project/delete-task/`,
                    {
                        headers: { Authorization: "Bearer " + token },
        ...
        async addTask({ commit }, task) {
            try {
                const res = await axios.post(
                    `${config.domain}/project/create-task`,
                    {
        ...
        async assessTask({ commit }, dataAssess) {
            try {
                const res = await axios.patch(
                    `${config.domain}/project/assess-task`,
                    {
